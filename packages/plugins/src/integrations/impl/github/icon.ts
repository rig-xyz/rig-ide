...
export const icon: PluginIconAsset = {
  ...
  variants: [
    {
      minSize: 0,
      light: `<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path fill="#1B1F23" fill-rule="evenodd" clip-rule="evenodd" d="${path}"/></svg>`,
      dark: `<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path fill="#f4f4f5" fill-rule="evenodd" clip-rule="evenodd" d="${path}"/></svg>`,
    },
  ],
};
