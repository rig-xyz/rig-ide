...
export const icon: PluginIconAsset = {
  ...
  variants: [
    {
      minSize: 0,
      light: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <defs>
    <linearGradient id="oh-my-pi-favicon-gradient" x1="0" y1="0" x2="1" y2="1">
  ...
  <path fill="url(#oh-my-pi-favicon-gradient)" d="M14 16h36v8H40v32h-8V24h-6v22h-8V24h-4z" />
</svg>`,
    },
  ],
};
