...
export const appController = createRPCController({
  ...
  openSelectDirectoryDialog: (args: {
    title: string;
    message: string;
    defaultPath?: string;
    requestedAt?: number;
  }) => appService.openSelectDirectoryDialog(args),
  openSelectDocumentFileDialog: (args: { title: string; message: string }) =>
    appService.openSelectDocumentFileDialog(args),
  openSelectAnyFileDialog: (args: { title: string; message: string }) =>
    appService.openSelectAnyFileDialog(args),
