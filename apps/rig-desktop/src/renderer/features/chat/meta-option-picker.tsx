 ...
 * (the shared `Popover` primitive's own placement flip is what makes this
 * open UPWARD near the composer, which sits at the bottom of the window —
 * Dylan's earlier feedback was a dropdown that opened downward off-screen;
 * this is the actual fix, reused rather than re-solved), but its own small
...
export function MetaOptionPicker({
  ...
  return (
    <>
      ...
      <Popover anchor={triggerRef} open={open} onClose={() => setOpen(false)} role="listbox" estimatedWidth={140} minWidth={140}>
